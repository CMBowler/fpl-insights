...
// DEFENDER
#define DEF_WEIGHT_GOALS     0.2
#define DEF_WEIGHT_ASSISTS   0.2
#define DEF_WEIGHT_XGI       0.1
#define DEF_WEIGHT_BP        0.4
#define DEF_WEIGHT_ICT       0.1
#define DEF_WEIGHT_GC        -0.3
#define DEF_WEIGHT_XGC       -0.15

// MIDFIELDER
#define MID_WEIGHT_GOALS     0.4
#define MID_WEIGHT_ASSISTS   0.2
#define MID_WEIGHT_XGI       0.05
...
// FORWARD
#define FWD_WEIGHT_GOALS     0.45
#define FWD_WEIGHT_ASSISTS   0.2
#define FWD_WEIGHT_XGI       0.05
#define FWD_WEIGHT_BP        0.15
#define FWD_WEIGHT_ICT       0.15
